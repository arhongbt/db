    ...
    <div className="min-h-dvh bg-background">
      <div className="max-w-2xl mx-auto px-5 py-8">
        ...
        <div className="prose-custom space-y-6">
          <section>
            <h2 className="font-display">{t('1. Om tjänsten', '1. About the service')}</h2>
            <p>
          ...
          <section>
            <h2 className="font-display">{t('2. Godkännande av villkor', '2. Acceptance of terms')}</h2>
            <p>
          ...
          <section>
            <h2 className="font-display">{t('3. Konto och ansvar', '3. Account and responsibility')}</h2>
            <p>
          ...
          <section>
            <h2 className="font-display">{t('4. Korrekt information', '4. Accurate information')}</h2>
            <p>
          ...
          <section>
            <h2 className="font-display">{t('5. Tjänstens begränsningar', '5. Service limitations')}</h2>
            <p>
          ...
          <section>
            <h2 className="font-display">{t('6. Immateriella rättigheter', '6. Intellectual property')}</h2>
            <p>
          ...
          <section>
            <h2 className="font-display">{t('7. Uppsägning', '7. Termination')}</h2>
            <p>
          ...
          <section>
            <h2 className="font-display">{t('8. Ansvarsbegränsning', '8. Limitation of liability')}</h2>
            <p>
          ...
          <section>
            <h2 className="font-display">{t('9. Tvistlösning', '9. Dispute resolution')}</h2>
            <p>
