    ...
    <div className="min-h-dvh bg-background">
      <div className="max-w-2xl mx-auto px-5 py-8">
        ...
        <div className="prose-custom space-y-6">
          <section>
            <h2>{t('1. Vilka vi är', '1. Who we are')}</h2>
            <p>
          ...
          <section>
            <h2>{t('2. Vilka uppgifter vi samlar in', '2. What information we collect')}</h2>
          ...
          <section>
            <h2>{t('3. Rättslig grund', '3. Legal basis')}</h2>
            <p>
          ...
          <section>
            <h2>{t('4. Hur vi skyddar dina uppgifter', '4. How we protect your information')}</h2>
            <p>
          ...
          <section>
            <h2>{t('5. Vilka vi delar uppgifter med', '5. Who we share information with')}</h2>
            <p>
          ...
          <section>
            <h2>{t('6. Hur länge vi sparar uppgifter', '6. How long we retain information')}</h2>
            <p>
          ...
          <section>
            <h2>{t('7. Dina rättigheter', '7. Your rights')}</h2>
          ...
          <section>
            <h2>{t('9. Tillsynsmyndighet', '9. Supervisory authority')}</h2>
            <p>
