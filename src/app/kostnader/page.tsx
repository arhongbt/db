    ...
    <div className="flex flex-col min-h-dvh px-4 py-5 pb-24">
      ...
      {totalKostnad > 0 && (
        <button
          ...
          className="card bg-accent/5 mb-6 flex items-center justify-between hover:bg-accent/10 transition-colors rounded-2xl" style={{ background: 'linear-gradient(135deg, rgba(107,127,94,0.06), rgba(107,127,94,0.02))', border: '1px solid rgba(107,127,94,0.15)' }}
        >
          <div>
