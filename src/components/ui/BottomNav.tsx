  ...
  return (
    <>
      ...
      {moreOpen && (
        <div
          ref={menuRef}
          className="fixed bottom-[calc(4rem+env(safe-area-inset-bottom))] left-0 right-0 z-50 bg-white rounded-t-3xl shadow-2xl border-t max-h-[70vh] overflow-y-auto mx-auto max-w-lg"
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t mx-auto max-w-lg" style={{ background: '#F7F5F0', borderColor: '#E8E4DE' }}>
