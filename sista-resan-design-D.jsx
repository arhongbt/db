...
/* ═══════════════════════════════════════════════════════════════
   SISTA RESAN — DESIGN D: "SOFT STRUCTURE"

   C:s layout (blobbar, gradient-kort, iconbubblor, organiska former)
   + A:s färgpalett (warm linen, sage green, warm charcoal, terracotta)

   Det bästa från båda världar.
   ═══════════════════════════════════════════════════════════════ */

// ── A:s färgpalett applicerad ──────────────────────────────────
const T = {
  // Backgrounds (from A — warm linen family)
  bgCream: "#F7F5F0",
  bgWarm: "#F0EDE6",
  bgCard: "#FFFFFF",
  bgPeach: "#FEF3EE",       // terracotta tint
  bgMint: "#EEF2EA",        // sage tint
  bgLavender: "#EDEAF4",    // muted lavender from A's dusty blue
  bgSky: "#EDF2F6",         // dusty blue tint

  // Text (from A — warm charcoal family)
  textDark: "#2A2622",
  textBody: "#6B6560",
  textLight: "#9C9590",
  textOnDark: "#FFFFFF",

  // Primary accent — Sage (from A)
  sage: "#6B7F5E",
  sageDark: "#4F6145",
  sageLight: "#8FA882",
  sageTint: "#EEF2EA",
  ...
  // Extended palette for C-style variety
  lavender: "#8E82B0",
  lavenderTint: "#EDEAF4",
  honey: "#C4974A",
  honeyTint: "#FDF6EA",
  ...
  border: "#E8E4DD",
  borderSoft: "#F0EDE6",
  shadow: "0 2px 8px rgba(42,38,34,0.04), 0 8px 24px rgba(42,38,34,0.04)",
  shadowHover: "0 4px 12px rgba(42,38,34,0.06), 0 12px 32px rgba(42,38,34,0.06)",

  // C:s radier (mer rundade)
  radius: "24px",
  radiusMd: "18px",
  radiusSm: "14px",
  radiusFull: "9999px",
...
const btnPrimary = {
  ...
  gap: "10px",
  transition: "all 0.25s ease",
  boxShadow: "0 4px 16px rgba(107,127,94,0.25)",
};
...
// ── C:s komponenter med A:s färger ─────────────────────────────
...
function NavTabD({ icon: Icon, label, active, onClick }) {
  return (
    <button onClick={onClick} style={{
      ...
      color: active ? T.sage : T.textLight,
...
function BottomNavD({ activeTab, setActiveTab }) {
  return (
    <nav style={{
      ...
      {[
        ...
        <NavTabD key={t.id} icon={t.icon} label={t.label}
...
function LandingD({ onNavigate }) {
  return (
    <div style={{ background: T.bgCream, minHeight: "100%", position: "relative", overflow: "hidden" }}>
      ...
      <BlobShape color={T.terracottaLight} size="220px" style={{ bottom: "30%", left: "-80px" }} />
      <BlobShape color={T.dustyBlueTint} size="160px" style={{ bottom: "10%", right: "-40px" }} />

      <section style={{ padding: "52px 28px 28px", position: "relative", zIndex: 1 }}>
        <div style={{
          width: 64, height: 64,
          borderRadius: "24px",
          background: `linear-gradient(135deg, ${T.sageTint}, ${T.bgMint})`,
          display: "flex", alignItems: "center", justifyContent: "center",
          marginBottom: "28px",
          boxShadow: "0 4px 16px rgba(107,127,94,0.12)",
        }}>
      ...
      <section style={{ padding: "0 28px 36px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          {[
            { icon: Clock, title: "Personlig tidslinje", desc: "Anpassad efter just din situation", color: T.dustyBlue, bg: T.dustyBlueTint, accent: T.bgSky },
            { icon: FileText, title: "Bouppteckning", desc: "Samla underlag steg för steg", color: T.sage, bg: T.sageTint, accent: T.bgMint },
            ...
            { icon: Bell, title: "Smarta påminnelser", desc: "Vi håller koll — du behöver inte", color: T.terracotta, bg: T.terracottaLight, accent: T.bgPeach },
          ].map((f, i) => (
            <div key={i} style={{
              ...softCard,
              padding: "20px",
      ...
      <section style={{ padding: "0 28px 36px", position: "relative", zIndex: 1 }}>
        ...
        {[
          ...
          { n: "2", title: "Följ din personliga plan", desc: "Vi visar vad som behöver göras härnäst", color: T.dustyBlue, bg: T.dustyBlueTint },
          { n: "3", title: "Ta det i din takt", desc: "Ingen brådska — allt sparas automatiskt", color: T.terracotta, bg: T.terracottaLight },
        ].map((s, i) => (
          <div key={i} style={{
      ...
      <section style={{ padding: "0 28px 36px", position: "relative", zIndex: 1 }}>
        <div style={{
          ...
          {[
            { icon: Scale, text: "Baserat på Ärvdabalken och Skatteverkets regler", color: T.sage },
            { icon: Lock, text: "Dina uppgifter stannar på din enhet", color: T.dustyBlue },
            { icon: Shield, text: "Grundversionen är helt gratis", color: T.terracotta },
          ].map((t, i) => (
  ...
  return (
    <div style={{ background: T.bgCream, minHeight: "100%", position: "relative", overflow: "hidden", paddingBottom: "16px" }}>
      ...
      <div style={{ padding: "0 28px", marginBottom: "20px", position: "relative", zIndex: 1 }}>
        <div style={{
          background: `linear-gradient(135deg, ${T.dustyBlueTint}, ${T.sageTint})`,
          borderRadius: T.radius,
          padding: "24px",
          border: `1px solid ${T.borderSoft}`,
          display: "flex", alignItems: "center", justifyContent: "space-between",
          cursor: "pointer",
          boxShadow: "0 4px 20px rgba(110,139,164,0.08)",
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            <IconBubble icon={Waves} color={T.dustyBlue} bgColor={`${T.dustyBlue}18`} size={52} />
            <div>
      ...
      <div style={{ padding: "0 28px", marginBottom: "24px", display: "flex", gap: "12px", position: "relative", zIndex: 1 }}>
        {[
          { icon: User, value: "3", label: "Delägare", color: T.sage, bg: T.sageTint },
          { icon: Calendar, value: "2", label: "Frister", color: T.terracotta, bg: T.terracottaLight },
        ].map((s, i) => (
          <div key={i} style={{
            ...softCard, flex: 1,
      ...
      <div style={{ padding: "0 28px", marginBottom: "24px", position: "relative", zIndex: 1 }}>
        ...
        {[
          { n: 1, label: "Kontakta banker", reason: "2 banker att meddela", color: T.terracotta, bg: T.terracottaLight },
          { n: 2, label: "Inventera tillgångar", reason: "Grund för bouppteckning", color: T.sage, bg: T.sageTint },
          { n: 3, label: "Kolla försäkringar", reason: "Dödsfallsersättning?", color: T.dustyBlue, bg: T.dustyBlueTint },
        ].map((a, i) => (
          <div key={i} style={{
            ...softCard,
      ...
      <div style={{ padding: "0 28px", marginBottom: "20px", position: "relative", zIndex: 1 }}>
        <div style={{
          ...softCard,
          background: `linear-gradient(135deg, ${T.terracottaLight}, ${T.bgCard})`,
          display: "flex", alignItems: "center", gap: "14px",
        }}>
          <IconBubble icon={AlertTriangle} color={T.terracotta} bgColor={`${T.terracotta}15`} size={44} />
          <div>
            <p style={{ fontWeight: 600, fontSize: "15px", color: T.textDark }}>Bouppteckning</p>
            <p style={{ fontSize: "13px", color: T.terracotta, fontWeight: 600, marginTop: "2px" }}>72 dagar kvar</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "0 28px", position: "relative", zIndex: 1 }}>
        <div style={{
          ...softCard,
          background: `linear-gradient(135deg, ${T.lavenderTint}, ${T.bgCard})`,
          display: "flex", alignItems: "center", justifyContent: "space-between",
          cursor: "pointer",
        }}>
    ...
    <div style={{ background: T.bgCream, minHeight: "100%", position: "relative", overflow: "hidden", paddingBottom: "16px" }}>
      ...
      <div style={{ padding: "28px 28px 0", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", gap: "8px", overflowX: "auto", paddingBottom: "4px", marginBottom: "14px" }}>
          {[
            { id: "all", label: "Alla", color: T.warmSlate, bg: T.bgWarm, activeBg: T.warmSlate },
            { id: "akut", label: "Nödbroms", color: T.terracotta, bg: T.terracottaLight, activeBg: T.terracotta },
            { id: "kart", label: "Kartläggning", color: T.dustyBlue, bg: T.dustyBlueTint, activeBg: T.dustyBlue },
            { id: "boup", label: "Bouppteckning", color: T.sage, bg: T.sageTint, activeBg: T.sage },
          ].map(f => (
        ...
        <button onClick={() => setShowDone(!showDone)} style={{
          ...
          marginBottom: "22px",
          background: showDone ? T.oliveTint : T.bgWarm,
          color: showDone ? T.olive : T.textLight,
        }}>
      ...
      <div style={{ padding: "0 28px", position: "relative", zIndex: 1, display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <div style={{
          padding: "10px 16px",
          background: `linear-gradient(135deg, ${T.terracottaLight}, ${T.bgCream})`,
          borderRadius: T.radiusSm,
          marginBottom: "4px",
          display: "flex", alignItems: "center", gap: "8px",
        }}>
          <div style={{ width: 6, height: 6, borderRadius: "50%", background: T.terracotta }} />
          <p style={{ fontSize: "13px", fontWeight: 700, color: T.terracotta }}>Nödbroms (dag 1–7)</p>
        </div>
        ...
        {filtered.filter(t => t.step === "akut").map((task, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              background: task.urgent ? `linear-gradient(135deg, ${T.terracottaLight}, ${T.bgCard})` : T.bgCard,
            }}>
              <div style={{
              ...
              <div style={{ flex: 1 }}>
                ...
                {task.deadline && !isKlar && (
                  <p style={{ fontSize: "12px", fontWeight: 700, marginTop: "6px", color: task.urgent ? T.terracotta : T.sage }}>
                    {task.deadline}
                  </p>
                )}
              </div>
        ...
        <div style={{
          padding: "10px 16px",
          background: `linear-gradient(135deg, ${T.dustyBlueTint}, ${T.bgCream})`,
          borderRadius: T.radiusSm,
          marginTop: "12px", marginBottom: "4px",
          display: "flex", alignItems: "center", gap: "8px",
        }}>
          <div style={{ width: 6, height: 6, borderRadius: "50%", background: T.dustyBlue }} />
          <p style={{ fontSize: "13px", fontWeight: 700, color: T.dustyBlue }}>Kartläggning (vecka 1–4)</p>
        </div>
...
function TokensD() {
  const groups = [
    { title: "Bakgrunder", colors: [
      { name: "Cream (Linen)", hex: T.bgCream }, { name: "Warm (Sand)", hex: T.bgWarm },
      { name: "Sage Tint", hex: T.sageTint }, { name: "Terracotta Tint", hex: T.terracottaLight },
      { name: "Blue Tint", hex: T.dustyBlueTint }, { name: "Lavender Tint", hex: T.lavenderTint },
    ]},
    { title: "Text", colors: [
      { name: "Dark (Charcoal)", hex: T.textDark }, { name: "Body", hex: T.textBody }, { name: "Light", hex: T.textLight },
    ]},
    { title: "Accent", colors: [
      { name: "Sage", hex: T.sage }, { name: "Sage Dark", hex: T.sageDark },
      { name: "Terracotta", hex: T.terracotta }, { name: "Dusty Blue", hex: T.dustyBlue },
      { name: "Lavender", hex: T.lavender }, { name: "Honey", hex: T.honey },
    ]},
  ];
  ...
  return (
    <div style={{ background: T.bgCream, minHeight: "100%", padding: "28px", paddingBottom: "16px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <p style={{ fontSize: "14px", color: T.textBody, marginBottom: "28px" }}>"Soft Structure" — C:s layout + A:s färger</p>
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            <IconBubble icon={Feather} color={T.sage} bgColor={T.sageTint} size={52} />
            <IconBubble icon={Heart} color={T.terracotta} bgColor={T.terracottaLight} size={52} />
            <IconBubble icon={Waves} color={T.dustyBlue} bgColor={T.dustyBlueTint} size={52} />
            <IconBubble icon={Sun} color={T.honey} bgColor={T.honeyTint} size={52} />
            <IconBubble icon={Leaf} color={T.lavender} bgColor={T.lavenderTint} size={52} />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {[
          { id: "landing", label: "Landing", color: T.sage },
          { id: "dashboard", label: "Dashboard", color: T.dustyBlue },
          { id: "tasks", label: "Uppgifter", color: T.terracotta },
          { id: "tokens", label: "Design System", color: T.warmSlate },
        ].map(v => (
      ...
      <div style={{ flex: 1 }}>
        {view === "landing" && <LandingD onNavigate={(v) => { setView(v); setTab("home"); }} />}
        {view === "dashboard" && <DashboardD />}
        {view === "tasks" && <TasksD />}
        {view === "tokens" && <TokensD />}
      </div>

      {view !== "landing" && <BottomNavD activeTab={tab} setActiveTab={handleTab} />}
    </div>
  );
}